...
class TestPluginValidator:
    ...
    def test_plugin_valid_content(mock_import_plugin, src_dir, plugin_config_file):
        plugin_config_content = OrderedDict(
            [
                ("id", str(uuid.uuid4())),
                ("name", "staged".encode("utf-8")),
    ...
    def test_plugin_version_format(
        mock_import_plugin, src_dir, plugin_config_file, version, expected
    ):
        plugin_config_content = OrderedDict(
            [
                ("id", str(uuid.uuid4())),
    ...
    def test_plugin_entry_point(
        mock_import_plugin, src_dir, plugin_config_file, entry_point, expected
    ):
        plugin_config_content = OrderedDict(
            [
                ("id", str(uuid.uuid4())),
    ...
    def test_plugin_id(
        mock_import_plugin, src_dir, plugin_config_file, plugin_id, expected
    ):
        plugin_config_content = OrderedDict(
            [
    ...
    @staticmethod
    @pytest.mark.parametrize(
        "validation_mode", [ValidationMode.INFO, ValidationMode.WARNING]
    )
