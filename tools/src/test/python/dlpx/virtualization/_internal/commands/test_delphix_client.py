...
class TestDelphixClient:
    ...
    SES_RESP_SUCCESS = (
        ...
        {
            "Set-Cookie": "JSESSIONID=8F075FBEC53E8413BC2D5EEF29EAA721;"
            " Path=/resources; HttpOnly",
            "X-Frame-Options": "SAMEORIGIN",
            "X-Content-Type-Options": "nosniff",
            "X-XSS-Protection": "1; mode=block",
            "Cache-Control": "max-age=0",
            "Expires": "Mon, 04 Feb 2019 06:00:12 GMT",
            "Content-Type": "application/json",
            "Content-Length": "180",
            "Date": "Mon, 04 Feb 2019 06:00:12 GMT",
        },
    )
    SES_RESP_FAIL = (
        (
        ...
        {
            "Set-Cookie": "JSESSIONID=E6A9006C615CACC0A3DC1BC65379B207;"
            " Path=/resources; HttpOnly",
            "X-Frame-Options": "SAMEORIGIN",
            "X-Content-Type-Options": "nosniff",
            "X-XSS-Protection": "1; mode=block",
            "Cache-Control": "max-age=0",
            "Expires": "Mon, 04 Feb 2019 05:41:49 GMT",
            "Content-Type": "application/json",
            "Content-Length": "392",
            "Date": "Mon, 04 Feb 2019 05:41:49 GMT",
        },
    )
    SES_RESP_UNKNOWN_FAIL = (
        '{"blob":"Unknown","status":"UNKNOWN"}',
        {
            "Set-Cookie": "JSESSIONID=E6A9006C615CACC0A3DC1BC65379B207;"
            " Path=/resources; HttpOnly",
            "X-Frame-Options": "SAMEORIGIN",
    ...
    LOGIN_RESP_SUCCESS = (
        ...
        ),
        {
            ...
            "X-Content-Type-Options": "nosniff",
            "X-XSS-Protection": "1; mode=block",
            "Set-Cookie": "JSESSIONID=A96E274A157195647944973CFEA37FBF;"
            " Path=/resources; HttpOnly",
            "Cache-Control": "max-age=0",
            "Expires": "Mon, 04 Feb 2019 07:10:16 GMT",
            "Content-Type": "application/json",
            "Content-Length": "76",
            "Date": "Mon, 04 Feb 2019 07:10:16 GMT",
        },
    )
    LOGIN_RESP_FAIL = (
        (
    ...
    TOKEN_RESP_FAIL = (
        ...
        {
            "Set-Cookie": "JSESSIONID=C007AE1F52A410365DA1F4A9FABC5871;"
            " Path=/resources; HttpOnly",
            "X-Frame-Options": "SAMEORIGIN",
            "X-Content-Type-Options": "nosniff",
            "X-XSS-Protection": "1; mode=block",
            ...
            "Content-Language": "en",
            "Content-Length": "364",
            "Date": "Mon, 04 Feb 2019 08:06:49 GMT",
        },
    )
    UPLOAD_RESP_SUCCESS = (
        (
            '{"type":"OKResult","status":"OK",'
    ...
    def test_delphix_client_upload_success(engine_api, artifact_content):
        ...
        assert history[-2].path == u"/resources/json/delphix/toolkit/requestUploadToken"
    ...
    def test_request_timeout(mock_post, engine_api):
        ...
        mock_post.assert_called_once_with(
            data=json.dumps({"version": engine_api, "type": "APISession"}),
    ...
    @pytest.mark.parametrize(
        "engine_api", [{"type": "APIVersion", "major": 2, "minor": 11, "micro": 0}]
    )
    def test_delphix_client_wrong_api(engine_api):
        ...
        assert error["action"] == (
            "Change the API version to one supported"
    ...
    def test_delphix_client_get_token_fail(engine_api, artifact_content):
        ...
        history = httpretty.HTTPretty.latest_requests
        assert history[-1].path == u"/resources/json/delphix/toolkit/requestUploadToken"
    ...
    def test_delphix_client_upload_fail(engine_api, artifact_content):
        ...
        assert error["action"] == (
            "Delete the following objects and try"
    ...
    @staticmethod
    def test_delphix_client_download_success(engine_api, src_dir, plugin_config_file):
        session_body, session_header = TestDelphixClient.SES_RESP_SUCCESS
        httpretty.register_uri(
            httpretty.POST,
            "http://test-engine.com/resources/json/delphix/session",
        ...
        history = httpretty.HTTPretty.latest_requests
        assert (
            history[-1].path == u"/resources/json/delphix/data/downloadOutputStream"
...
class TestEngineApi:
    ...
    def test_get(engine_api, artifact_content):
        assert (
            delphix_client.DelphixClient.get_engine_api(artifact_content) == engine_api
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            None,
            "not a dict",
            {"type": "APIVersion", "major": "not an int", "minor": 11, "micro": 0},
        ],
    )
