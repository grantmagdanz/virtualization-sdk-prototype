...
def execute_swagger_codegen(swagger_file, config_file, output_dir):
    ...
    codegen_template = os.path.join(
        os.path.dirname(codegen.__file__), codegen.CODEGEN_TEMPLATE_DIR
    )
...
class TestTemplateStringProperty:
        ...
        content = {
            "TestDefinition": {
                ...
                "properties": {
                    ...
                    "requiredStringProperty": {"type": "string", "pattern": "^test.*"},
                },
    ...
    def test_unicode_success_setter(module):
        ...
        assert test_object.string_property == u"\u2346\u2633\u9476\u0369\u2468\u1111"
    ...
    def test_required_param_missing(module):
        ...
        assert message == (
            "The required parameter 'required_string_property'" " must not be 'None'."
        )
    ...
    def test_min_length(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'string_property', length was 4"
    ...
    def test_max_length(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'string_property', length was 23"
    ...
    def test_bad_pattern(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'required_string_property',"
...
class TestTemplateNumericProperty:
    ...
    def schema_content():
        content = {
            "TestDefinition": {
                ...
                "additionalProperties": False,
                "properties": {
                    "numberProperty": {"type": "number", "minimum": 10.0},
                    "requiredNumberProperty": {
                        "type": "number",
                        "minimum": 2.0,
                        "exclusiveMinimum": True,
                    },
                    "integerProperty": {"type": "integer", "maximum": 20},
                ...
                "required": ["requiredNumberProperty", "requiredIntegerProperty"],
            }
        }
        return content
    ...
    def test_required_param_missing(module):
        ...
        message = err_info.value.message
        assert message == (
            "The required parameter 'required_number_property'" " must not be 'None'."
        )
        ...
        message = err_info.value.message
        assert message == (
            "The required parameter 'required_integer_property'" " must not be 'None'."
        )
    ...
    def test_minimum(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'number_property', value was 1.0"
    ...
    def test_maximum(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'integer_property', value was 21"
    ...
    def test_exclusive_minimum(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'required_number_property',"
    ...
    def test_exclusive_maximum(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid value for 'required_integer_property',"
...
class TestTemplateObjectProperty:
    ...
    def test_success(module):
        ...
        test_object = module.TestDefinition(
            ...
            number_dict_property={"k0": 5.0, "k1": 3.14j},
        ...
        test_dict = test_object.to_dict()
        assert test_dict == {
            "definedObjectProperty": {"numberProperty": 1, "stringProperty": "str"},
            "numberDictProperty": {"k1": 3.14j, "k0": 5.0},
            "booleanDictProperty": {"key": True},
            "requiredObjectProperty": {
                "key": {"numberProperty": 1, "stringProperty": "str"}
            },
        }
        from_dict_object = module.TestDefinition.from_dict(test_dict)
        assert test_object == from_dict_object
    ...
    def test_required_param_missing(module):
        ...
        message = err_info.value.message
        assert message == (
            "The required parameter 'required_object_property'" " must not be 'None'."
        )

    @staticmethod
    def test_required_param_missing_setter(module):
        test_object = module.TestDefinition(required_object_property={"key": "value"})
    ...
    def test_object_is_array(module):
        with pytest.raises(module.GeneratedClassesTypeError) as err_info:
            module.TestDefinition(required_object_property=["this", "is", "a", "list"])
    ...
    def test_object_dict_with_bad_key_type(module):
        with pytest.raises(module.GeneratedClassesTypeError) as err_info:
            module.TestDefinition(
                required_object_property={"key": "value", 10: 11, True: "t"}
            )
        ...
        message = err_info.value.message
        assert message in possible_messages, assertion_error_message.format(
            possible_messages[0], message
        )
    ...
    def test_object_dict_with_bad_key_type_setter(module):
        ...
        with pytest.raises(module.GeneratedClassesError) as err_info:
            test_object.required_object_property = {"key": "value", 10: 11, True: "t"}
...
class TestTemplateArrayProperty:
    ...
    def test_required_param_missing(module):
        ...
        message = err_info.value.message
        assert message == (
            "The required parameter 'required_array_property'" " must not be 'None'."
        )
    ...
    def test_array_is_object(module):
        with pytest.raises(module.GeneratedClassesTypeError) as err_info:
            module.TestDefinition(
                array_property={"this": "is", "a": "dict"}, required_array_property=[]
            )
    ...
    def test_string_array_wrong_elem_types(module):
        with pytest.raises(module.GeneratedClassesTypeError) as err_info:
            module.TestDefinition(
                string_array_property=["one", 2, 3.0], required_array_property=[]
            )
...
class TestTemplateBooleanProperty:
        ...
        content = {
            "TestDefinition": {
                ...
                "properties": {
                    ...
                    "requiredBooleanProperty": {"type": "boolean"},
                },
    ...
    def test_success(module):
        test_object = module.TestDefinition(
            boolean_property=True, required_boolean_property=False
        )
        ...
        test_dict = test_object.to_dict()
        assert test_dict == {"booleanProperty": True, "requiredBooleanProperty": False}
        from_dict_object = module.TestDefinition.from_dict(test_dict)
        assert test_object == from_dict_object
    ...
    def test_required_param_missing(module):
        ...
        message = err_info.value.message
        assert message == (
            "The required parameter 'required_boolean_property'" " must not be 'None'."
        )
...
class TestTemplateEnumProperty:
        ...
        content = {
            "TestDefinition": {
                ...
                "properties": {
                    ...
                    "stringProperty": {"type": "string", "enum": ["A", "B", "C"]},
                    "requiredObjectProperty": {
                        "type": "object",
                    ...
                    "requiredArrayProperty": {
                        "type": "array",
                        "items": {"type": "string", "enum": ["DO", "RE", "MI"]},
                    },
                    "arrayProperty": {
                        "type": "array",
                        "items": {"type": "string", "enum": ["DO", "RE", "MI"]},
    ...
    def test_successs(module):
        test_object = module.TestDefinition(
            ...
            required_object_property={"ONE": "uno", "TWO": "dos"},
            required_array_property=["DO", "RE", "MI"],
        )
        assert test_object.required_string_property == "A"
        assert test_object.required_object_property == {"ONE": "uno", "TWO": "dos"}
        ...
        assert test_dict == {
            ...
            "stringProperty": None,
            "requiredObjectProperty": {"TWO": "dos", "ONE": "uno"},
            "objectProperty": None,
    ...
    def test_string_incorrect_enum_setter(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid enum value D for 'string_property', must"
    ...
    def test_array_incorrect_enum(module):
        ...
        message = err_info.value.message
        assert message == (
            "Invalid values for 'array_property'. Was [FA, SO]"
